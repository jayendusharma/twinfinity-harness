...
manifest source and destination byte, mode, owner, manifest digest, and source
commit. It also verifies state-specific installer evidence and binds the actual
target directory identity. A staged root requires its exact fixed
