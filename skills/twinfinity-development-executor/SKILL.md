...
10. Perform terminal cleanup, publish one GitHub-safe owning-issue receipt through the SQLite outbox, transition the exact item/watch terminally, release the exact capacity and lease, and hand the delta to the Product Planner.
